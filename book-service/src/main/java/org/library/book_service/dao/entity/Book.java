package org.library.book_service.dao.entity;
...
public class Book {
    ...
    public Book(UUID uuid, String isbn, String title, BookGenre genre, String description, String author) {
        this.uuid = uuid;
        this.isbn = isbn;
        this.title = title;
        this.genre = genre;
    ...
    public Book(UUID uuid, String isbn, String title, BookGenre genre, String description, String author, LocalDateTime createDate, LocalDateTime updateDate) {
        this.uuid = uuid;
        this.isbn = isbn;
        this.title = title;
        this.genre = genre;
